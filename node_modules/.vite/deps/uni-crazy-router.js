...
// E:/lwz/lwz/mine/uniapp-base/node_modules/regenerator-runtime/runtime.js
var require_runtime = __commonJS({
  "E:/lwz/lwz/mine/uniapp-base/node_modules/regenerator-runtime/runtime.js"(exports, module) {
...
// E:/lwz/lwz/mine/uniapp-base/node_modules/uni-crazy-router/dist/index.js
...
var h = [];
var l = [];
var f = { allowAction: true, routerParams: null, passedParams: null, current: {}, afterNotNext: null, actionInfo: { navigateBack: null, switchTab: null }, actionType: null };
var p = /[^\x20-\x7E]/;
var m = /[\x2E\u3002\uFF0E\uFF61]/g;
...
var M = { javascript: true, "javascript:": true };
...
var J = process.env.VUE_APP_PLATFORM;
var Q = 0;
if ("h5" === J) {
...
function ot() {
  return ot = a(import_regenerator_runtime.default.mark(function t2(e2) {
...
function ct() {
  return (ct = a(import_regenerator_runtime.default.mark(function t2(e2, r2, n2) {
    var a2, o2, s2, u2, c2;
    return import_regenerator_runtime.default.wrap(function(t3) {
      for (; ; )
        switch (t3.prev = t3.next) {
...
function vt() {
  return (vt = a(import_regenerator_runtime.default.mark(function t2(e2, r2, n2, a2) {
    var o2;
    return import_regenerator_runtime.default.wrap(function(t3) {
      for (; ; )
        switch (t3.prev = t3.next) {
...
function wt() {
  var t2 = xt(), e2 = dt(t2);
  return "h5" !== J && (e2 = gt(e2)), { url: bt(), routeParams: t2.$routeParams, passedParams: t2.$passedParams, query: e2, search: yt(e2) };
}
function Pt(t2) {
  ...
  uni[t2] = function(r2) {
    return function(t3) {
      ...
      if ("navigateBack" === n2) {
        ...
        0 > b2 && (b2 = 0), f.actionInfo.navigateBack = b2, p2 = getCurrentPages()[b2].route, g2 = yt(v2 = dt(getCurrentPages()[b2])), "h5" !== J && (v2 = gt(v2));
      } else {
        ...
        return import_regenerator_runtime.default.wrap(function(e5) {
          for (; ; )
            switch (e5.prev = e5.next) {
              ...
              case 6:
                st = true, "h5" === J && (Q = 0), w2 = at(t3, r3, n2), Y();
              case 10:
              case "end":
                return e5.stop();
            }
        ...
        return import_regenerator_runtime.default.wrap(function(e5) {
          for (; ; )
            switch (e5.prev = e5.next) {
              ...
              case 6:
                return st = true, "h5" === J && (Q = 0), a2 = at(t3, r3, n2), Y(), e5.abrupt("return", mt(a2, P2, ["app-plus", "app"].indexOf(J) > -1 ? o2 : f.current, n2));
              case 11:
              case "end":
                return e5.stop();
            }
...
var Et = Ct.beforeEach;
var St = Ct.afterEach;
var It = Ct.onError;
var Rt = Ct.afterNotNext;
var dist_default = Ct;
export {
  St as afterEach,
  Rt as afterNotNext,
