...
export const useGlobalStore = defineStore('global', {
  state: () => ({
    systemInfo: {},//系统信息[安卓平台,ios,版本信息都在这里]
    radio: 1,//px-rpx比率
    safeAreaTopHeight: 0, // 顶部状态栏(安全区)高度rpx
    pubHeaderHeight: 0,//公用顶部标题栏高度rpx[自动获取，不用理会，修改请到pub-header组件]
    safeAreaBottomHeight: 0,//底部安全区高度rpx
    pubTabbarHeight: 0,//公用底部选项卡高度rpx[自动获取，不用理会，修改请到pub-tabbar组件]
    screenHeight: 0,//可用屏幕高度rpx[除去顶部状态栏和底部安全区的高度]
    windowHeight: 0,//整个视窗高度rpx
    os:'',//操作系统 andriod ios windows等
    os_v:'',//系统版本号
    isWxXcx:false,//是否微信小程序
  }),
  actions: {
    //px换算成rpx
    pxToRpx(px) {
    ...
    getSysInfo() {
      ...
      this.setScreenHeight(
        this.pxToRpx(sysInfo.windowHeight) -
        this.safeAreaTopHeight -
        this.safeAreaBottomHeight
      );
